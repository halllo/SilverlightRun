SilverlightRun (SR) is a toolkit for Windows Phone 7 that I use to start off coding faster. SilverlightRunSample is a demo app that utilizes SR's easy tombstoning features, zooming and view model location. It also works as a basic tutorial.
