...
{
    /// <summary>
    /// Fundamental inversion of control container for basic dependency injection.
    /// © by http://caliburnmicro.codeplex.com/wikipage?title=SimpleContainer&referringTitle=Documentation
    /// </summary>
    public class SimpleContainer
    {
        ...
        internal object BuildInstance(Type type)
        {
